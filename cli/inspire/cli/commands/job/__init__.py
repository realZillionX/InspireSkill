...
def job() -> None:
    ...
    Examples:
        ...
        inspire job create --name train-a --workspace 分布式训练空间 --project <project> --group H200-2号机房 -q 8,160,1800 --image <image> --nodes 2 --command "bash repo/train.sh" --priority 4
