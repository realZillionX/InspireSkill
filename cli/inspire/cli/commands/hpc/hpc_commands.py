...
from inspire.services.hpc.hpc_instances import (
    ...
    hpc_instance_views as hpc_instance_views,
...
from inspire.services.hpc.hpc_submission import (
    ...
    SlurmLayoutError as SlurmLayoutError,
    SlurmLayout as SlurmLayout,
    resolve_slurm_layout as resolve_slurm_layout,
    build_hpc_create_payload as _build_hpc_create_payload,
)
...
def build_hpc_create_payload(**kwargs):
    return _build_hpc_create_payload(**kwargs, image_resolver=resolve_image_url)
...
def list_hpc(
    ...
    try:
        ...
        status_query = normalize_status(status_filter) if status_filter else None
