...
- [`references/dev/browser-api-actions.md`](references/dev/browser-api-actions.md)：CLI 维护参考，12 条路由 113 个 Action 的请求体、响应、参数语义、CLI 映射与限制。
